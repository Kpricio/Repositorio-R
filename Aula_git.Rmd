...
com o **add** sendo o nosso código para adicionar uma nova referencia remota, **origin** será o nome da nossa referencia e **URL_DO_REPOSITORIO** é o endereço do repositório no GitHub.
